...
function FullInfo({ title, image_url, population, region, capital }) {
    return (
        <div className="container rounded-lg shadow-lg bg-white dark:bg-gray-700 dark:text-white pb-4 w-11/12">
            <img src={image_url} className="w-full h-1/2 rounded-tl-lg rounded-tr-lg" alt={title} />
            <div className="p-4">
